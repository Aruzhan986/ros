...
import 'package:flutter_ros/ros/rosseven.dart';

class rossix extends StatefulWidget {
  @override
  _IndexedStackWidgetState createState() => _IndexedStackWidgetState();
}

class _IndexedStackWidgetState extends State<rossix> {
  int _index = 0;
  double size = 100.0;
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => rosseven()),
              );
            },
